...
<html lang="ar" dir="rtl">
    ...
    <body>
        ...
        {{-- <a href="/subscribe" class="floating subscribe-link me-3" data-action="subscriber/whatsapp/subscribe"><i
                class="fa-regular fa-envelope fa-2x" style="color:black" aria-hidden="true"></i></a> --}}
            ...
            <div id="content">
                    ...
                    <nav class="navbar navbar-expand-sm navbar-light bg-light">
                        <div class="container-fluid">
                            <button class="btn " type="button" id="sidebarCollapse"
                                style="background-color: #9bafca; "><i class="fas fa-align-left"
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form class="form-inline me-2 me-lg-0" action="/search" method="GET" name="search">
                                    <div class="search-form"><input class="form-control ms-sm-2" type="search"
                                            placeholder="أدخل كلمة البحث" aria-label="بحث" name="q"><button
                                            class="btn btn-outline-primary " type="submit">بحث</button>@auth <a
                                            href="/lastAddedWisdom" class="btn btn-outline-secondary">آخر حكمة</a>
                                        @endauth</div>
                                </form>
                            </div>
                        </div>
                ...
                <footer>
                    <div class="jumbotron text-center">
                        ...
                        @auth
                        <form method="get" action="/signout"><button class="logout-button" type="submit"
                                style="margin:auto;">تسجيل الخروج</button></form>
                        @else
                        <p><a href="https://www.instagram.com/dr.almotawa" target="_blank"><img
                                    ...
                                    class="social-media-icon"></a><a href="https://www.twitter.com/dralmotawaa"
                                target="_blank"><img src="{{asset('/images/Twitter-Dr-Abdulaziz.png')}}"
                                    alt="twitter.com" class="social-media-icon"></a></p>
                        <a href="https://rapidapi.com/mohammed7134/api/dr-almotawa-quotes" target="_blank">
                            <img src="https://storage.googleapis.com/rapidapi-documentation/connect-on-rapidapi-dark.png"
                                width="100" alt="Connect on RapidAPI">
                        </a>
                        @endauth
