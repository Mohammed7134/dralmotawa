<div class="blog_post">
    <div>
        ...
        <div class="d-flex toolbar">
            ...
            <a class="twitter-button" href='https://twitter.com/intent/tweet?text={{adjustLineBreaks($displayed,false)}}%0A@dralmotawaa' target="_blank"><i class="fa-brands fa-twitter" style="color:black;"></i></a>
